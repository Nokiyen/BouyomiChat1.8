 ...
 * 		FMLCorePlugin: noki.bouyomichat.asm.ASMLoadingPlugin
...
public class ASMLoadingPlugin implements IFMLLoadingPlugin {
	...
	//******************************//
	public static final Logger LOGGER = Logger.getLogger("bouyomichat");
	...
	public String[] getASMTransformerClass() {
		...
		return new String[] {"noki.bouyomichat.asm.ASMClassTransformer"};
	...
	public String getModContainerClass() {
		...
		return "noki.bouyomichat.asm.ASMModContainer";
